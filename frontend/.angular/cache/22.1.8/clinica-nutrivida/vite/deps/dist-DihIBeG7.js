import { r as __exportAll } from "./BrowserPerformanceMeasurement-DkPCwiJQ.js";
...
function getPerfMeasurementModule() {
	...
	try {
		...
		if (Number(perfEnabled) === 1) return import("./BrowserPerformanceMeasurement-DkPCwiJQ.js").then((n) => n.n);
	} catch (e) {}
}
/**
...
//#endregion
export { CacheLookupPolicy as A, StubPerformanceClient as B, MemoryStorage as C, BrowserConfigurationAuthError as D, BrowserConfigurationAuthErrorCodes_exports as E, BrowserAuthError as F, ClientConfigurationErrorCodes_exports as G, Logger as H, enforceResourceParameter as I, ProtocolMode as J, ClientConfigurationError as K, ServerError as L, InteractionType as M, WrapperSKU as N, ApiId as O, BrowserAuthErrorCodes_exports as P, InteractionRequiredAuthError as R, BrowserRootPerformanceEvents_exports as S, blockReloadInHiddenIframes as T, AzureCloudInstance as U, LogLevel as V, AuthenticationHeaderParser as W, ClientAuthError as X, ClientAuthErrorCodes_exports as Y, AuthError as Z, EventHandler as _, ResponseMode as a, SessionStorage as b, EventMessageUtils as c, PublicClientApplication as d, createNestablePublicClientApplication as f, NavigationClient as g, DEFAULT_IFRAME_TIMEOUT_MS as h, PromptValue as i, InteractionStatus as j, BrowserCacheLocation as k, loadExternalTokens as l, isPlatformBrokerAvailable as m, JsonWebTokenTypes as n, BrowserPerformanceClient as o, createStandardPublicClientApplication as p, AuthErrorCodes_exports as q, OIDC_DEFAULT_SCOPES as r, SignedHttpRequest as s, AuthenticationScheme as t, stubbedPublicClientApplication as u, version as v, BrowserUtils_exports as w, LocalStorage as x, EventType as y, InteractionRequiredAuthErrorCodes_exports as z };
